...
// 空间级别文本映射
export const SPACE_LEVEL_MAP: Record<number | undefined, string> = {
  undefined: '全部',
  0: '普通版',
  1: '专业版',
  2: '旗舰版',
...
}).sort((a, b) => b.value - a.value) // 按照枚举值降序排序，确保专业版在前面
...
// 空间类型文本映射
export const SPACE_TYPE_MAP: Record<number | undefined, string> = {
  undefined: '全部',
  0: '私有空间',
  1: '团队空间',
}
