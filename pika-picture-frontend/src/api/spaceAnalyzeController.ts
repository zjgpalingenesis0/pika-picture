...
/** getSpaceTagsAnalyze POST /api/space/analyze/tags */
export async function getSpaceTagsAnalyzeUsingPost(
  body: API.SpaceTagsAnalyzeRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListSpaceTagsAnalyzeResponse_>('/api/space/analyze/tags', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
